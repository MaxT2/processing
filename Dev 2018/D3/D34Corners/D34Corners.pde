...
// after altering their project to use variables you can have them
// test to make sure it works by having them change their size
// the squares should always take up 1 corner of the screen no matter what
// size they input beause we used variables!